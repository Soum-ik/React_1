      ...
      <div className=" bg-neutralSilver">
        <div className=" px-4 lg:px-14 max-w-screen-2xl mx-auto min-h-screen h-screen">
          <Carousel className=" w-10/12 mx-auto">
            <div className=" md:mx-10 my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse item-center justify-between gap-12">
              <div>
            ...
            </div><div className=" md:mx-10 my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse item-center justify-between gap-12">
              <div>
                <img src={illustion} alt="" />
              </div>
              <div className=" md:w-1/2 pt-10">
